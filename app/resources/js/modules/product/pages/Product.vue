    ...
    <main class="main">
      <div class="container">
        <ul class="breadcrumb">
          <li class="breadcrumb__item breadcrumb__item--hide">
            <a href="" class="breadcrumb__link">
                <span class="breadcrumb__span">home</span>
            </a>
          </li>
          <li class="breadcrumb__item">
            <a href="" class="breadcrumb__link">
                <span class="breadcrumb__span">products</span>
            </a>
          </li>
          <li class="breadcrumb__item">
            <a href="" class="breadcrumb__link">
                <span class="breadcrumb__span">{{ product.name }}</span>
            </a>
          </li>
        </ul>
        <div class="product">
          <div class="product__header">
            ...
            <div class="product__row">
              ...
              <div class="product__left">
                ...
                <div class="product__info">
                  ...
                  <div class="rating">
                    <div class="rating__star">
                        <span class="rating__rate" :data-title="rate.title"
                            v-for="rate in ratings" :key="rate.title"
                            @click="rateWidth = rate.width" @mouseover="handleMouseover"
                ...
                <div class="product__info">
                    {{ formattedPrice(product.cost) }}
                </div>
                <div>
                  <button class="btn btn--boxshadow btn--brand" @click="addItem(product)">
                    add to cart
                  </button>
                </div>
        ...
        <SwiperSlider v-if="products.length">
          <template v-slot:title> Популярные товары </template>
          <router-link v-for="item in products" :to="{ name: 'Product', params: { id: item.id } }" class="swiper-slide" :key="item.id">
            <div class="card">
          ...
          <div class="tab">
            <div class="tab__items">
              <span class="tab__item tab__item--compare"
                ...
                @click="activeTab = 'compare'">Описание</span>
              <span class="tab__item tab__item--featrues"
                :class="{ 'tab__item--is-active': activeTab === 'featrues' }"
                @click="activeTab = 'featrues'">Характеристики</span>
              <span class="tab__item tab__item--comments"
                :class="{ 'tab__item--is-active': activeTab === 'comments' }"
                @click="activeTab = 'comments'">Коментарии</span>
            </div>
            <div class="tab__sections">
              <CompareTab :desc="product.desc" :style="activeTab === 'compare' ? 'display:block;' : 'display:none;' "/>
...
import { SET_PRODUCTS_MUTATIONS } from '@/store/product/types'
